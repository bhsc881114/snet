...
//	 * @param netConnect
//	 */
//	public void register(AbstractNet netConnect) {
//		final SClient clinetNet = (SClient) netConnect;
...
//			iter.remove();
//			AbstractNet ch = (AbstractNet) key.attachment();
//			try{
//				handleKey(key,ch);
...
//	}
//
//	void handleKey(SelectionKey key,AbstractNet ch) {
//		if (key.isReadable()) { // 读信息
//			onReadyToRead(key);
//		}
//		if (key.isWritable()) { // 写事件
//			writeInReactor((SClient)ch);
//		}
//
//	}
//
...
//		clientBuffer.clear();
//		final SClient ch = (SClient) key.attachment();
//
//		int count = 0;
//		// 从客户端读过来的数据块
//		try {
...
//	 * @param obj
//	 */
//	protected void writeInUser(SClient ch, WriteObj wobj) {
...
//	 * @param ch
//	 */
//	protected void writeInReactor(SClient ch) {
//		boolean open = true;
...
//		SClient ch = (SClient) k.attachment();
//		//内部会调用k.cancel()
//		ch.close();
//		//k.cancel();
//		cancelledKeys++;
...
//	 * @return
//	 */
//	protected boolean scheduleWriteIfNecessary(final SClient ch) {
