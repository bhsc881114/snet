package code.github.snet.core.codec;

//package code.github.snet.codec;
//
...
//	 * @throws Exception
//	 */
//	public void decodeMsg(SClient clientChannel, ByteBuffer input) {
//		// cumulation表示缓存的数据
//		// 1.如果之前没有缓存数据
//		if (cumulation == null) {
//			// 1.1直接尝试decode
...
//	 * @throws Exception
//	 */
//	protected abstract Object decode(SClient bsNet, ByteBuffer buffer);
//
//	private void callDecode(final SClient clientChannel, ByteBuffer cumulation) {
//
...
//	}
//
//	public void cleanup(SClient clientChannel) {
